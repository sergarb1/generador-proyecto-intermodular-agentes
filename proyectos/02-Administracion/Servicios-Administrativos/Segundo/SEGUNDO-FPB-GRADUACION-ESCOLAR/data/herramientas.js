...
<div class="callout callout-success">
    <div class="callout-title">
        <span>💡</span>
        <span>Ventaja de Google Workspace</span>
    </div>
...
<div class="callout callout-warning">
    <div class="callout-title">
        <span>⚠️</span>
        <span>Importante: Privacidad de Datos</span>
    </div>
...
<div class="callout callout-success">
    <div class="callout-title">
        <span>🎯</span>
        <span>Reto de Herramientas</span>
    </div>
    <p>Antes de continuar, <strong>crea tu primera invitación en Canva</strong> y compártela con el equipo para recibir feedback.</p>
</div>
`;
