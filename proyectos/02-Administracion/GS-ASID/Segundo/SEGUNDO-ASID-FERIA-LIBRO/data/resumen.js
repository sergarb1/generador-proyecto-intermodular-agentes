...
<p>Este proyecto intermodular integra competencias de múltiples módulos del ciclo de <strong>Asistencia a la Dirección</strong>:</p>
<ul class="list-disc list-inside space-y-2 my-6 text-slate-700">
    <li><strong>Gestión Económico-Financiera:</strong> Estudio de viabilidad, presupuestos y control de gastos</li>
    <li><strong>Gestión de Recursos Humanos:</strong> Organización del equipo de trabajo y voluntariado</li>
    <li><strong>Gestión Comercial:</strong> Plan de marketing, patrocinios y comunicación</li>
    <li><strong>Gestión Administrativa:</strong> Trámites legales, permisos y documentación oficial</li>
    <li><strong>Gestión de la Información:</strong> Bases de datos de autores, stands y visitantes</li>
    <li><strong>Gestión Logística:</strong> Coordinación de espacios, materiales y proveedores</li>
</ul>
...
<div class="callout callout-success">
    ...
    <p>Al finalizar este proyecto, el alumnado habrá desarrollado un <strong>plan ejecutivo completo</strong> que podría implementarse realmente, demostrando competencias profesionales de nivel superior en organización de eventos culturales.</p>
</div>
`;
